...
public class Nature extends Fragment {
    @Nullable
    private RecyclerView mNatureList,creditList;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mNatureList = (RecyclerView) view.findViewById(R.id.blog_list);
        creditList = (RecyclerView) view.findViewById(R.id.blog_list2);
        mNatureList.setHasFixedSize(true);
        creditList.setHasFixedSize(true);
        mNatureList.setNestedScrollingEnabled(false);
        ...
        manager.setReverseLayout(true);
        manager.setStackFromEnd(true);
        mNatureList.setLayoutManager(Manager);
        creditList.setLayoutManager(manager);
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Blog");
        databaseReference=FirebaseDatabase.getInstance().getReference().child("Users");
        mDatabase.keepSynced(true);
        databaseReference.keepSynced(true);
        query=mDatabase.orderByChild("title").equalTo("Nature");
        query2=databaseReference.orderByChild("credit").limitToLast(6);
        mNatureList.setAdapter(new NatureAdapter(Blog.class,R.layout.blog_row,BlogViewHolder.class,query,getActivity()));
 ...
 class NatureAdapter extends FirebaseRecyclerAdapter<Blog,BlogViewHolder>{
  ...
  public NatureAdapter(Class<Blog> modelClass, int modelLayout, Class<BlogViewHolder> viewHolderClass, Query ref,Context context) {
    ...
    protected void populateViewHolder(BlogViewHolder viewHolder, Blog model, int position) {
        ...
        final String post_key = getRef(position).getKey();
         final String uid=model.getUid();
            ...
            viewHolder.setProfile(new Nature().getActivity(), model.getProfileImage());
